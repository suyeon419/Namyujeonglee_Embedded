...
- 모터 제어 : 버튼 입력을 통해 일정 시간 모터의 정방향/역방향 회전과 작동을 제어함.
- RGB RED 제어 : 모터의 상태에 따라 RGB LED 색상을 변경함.
- 멀티쓰레드 및 뮤텍스 사용 : 쓰레드를 사용해 버튼 입력, 모터 제어 등을 독립적으로 처리하고 뮤텍스를 통해 공용 자원을 관리함.
